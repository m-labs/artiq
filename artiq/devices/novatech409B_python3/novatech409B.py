...
class Novatech409B:
    ...
    def __init__(self, comport=1, debug=1, simulate_hw=False):
        ...
        if self.simulate_hw == False:
            ...
            if (self.__platform == 'Windows'):
                ...
                self.debugMessage('__init__',
                    'unknown platform', level=0)
                sys.exit()
    ...
    def serSend(self, myStr, ignoreUnusualResponse=False):
        ...
        if self.simulate_hw==False :
            ...
            #after convert to python3 need to specify type of return to be bytes
            if(ignoreUnusualResponse==False):
