...
class Sampler:
    ...
    """
    kernel_invariants = {"bus_adc", "bus_pgia", "core", "cnv", "div", "v_span"}
    ...
    def __init__(self, dmgr, spi_adc_device, spi_pgia_device, cnv_device,
        ...
        self.div = div
        self.gains = 0x0000
        self.v_span = 10.  # 5 Volt reference, 0.5 AFE diff gain
    ...
    def sample(self, data):
        ...
        for i in range(n):
            ...
            data[i] = adc_mu_to_volt(adc_data[i], gain, self.v_span)
