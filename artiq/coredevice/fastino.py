...
class Fastino:
    ...
    def set_group_mu(self, dac: TInt32, data: TList(TInt32)):
        """Write a group of DAC channels in machine units. To specify
        group, use index of first channel in group; i.e., with ``log2_width = 4``,
        reference first group by channel 0, second by channel 16.
    ...
    def set_group(self, dac, voltage):
        """Set DAC group data to given voltage. To specify
        group, use index of first channel in group; i.e., with ``log2_width = 4``,
        reference first group by channel 0, second by channel 16.
    ...
    def set_leds(self, leds):
        ...
        :param leds: Bit mask of LED status (8-bit).
        """
