...
class SongbirdExample(EnvExperiment):
    ...
    def run(self):
        ...
        self.songbird0_clear.clear(0b1111)
        ...
        self.songbird0_dds0.set_waveform(
            ampl_offset=volt_to_mu(0.5), 
            damp=0, ddamp=0, dddamp=0,
            phase_offset=0, 
            ftw=self.songbird0_dds0.frequency_to_mu(50.0*MHz),
            chirp=0,
            shift=0
        )
        ...
        self.songbird0_dds1.set_waveform(
            ...
            damp=0, ddamp=0, dddamp=0,
            phase_offset=0,
            ftw=self.songbird0_dds1.frequency_to_mu(100*MHz),
            chirp=0,
            shift=0
        )
        delay(10*us)
        ...
        self.songbird0_trigger.trigger(0b0011)
        delay(1*us)
