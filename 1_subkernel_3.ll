...
entry:
  ...
  %subkernel.await.args = call i8 @subkernel_await_message(i32 0, i64 10000, i8 1, i8 2), !dbg !13
...
rpc.tail.twoja:                                   ; preds = %rpc.head.twoja
  ...
  %.12.not = icmp eq i8 %subkernel.await.args, 0, !dbg !13
  br i1 %.12.not, label %optarg.tail.b, label %optarg.get.b, !dbg !13
