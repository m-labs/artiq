...
entry:
  %.14.i = alloca { i8*, i32 }, align 8, !dbg !9
  %subkernel.return.i = alloca i8*, align 4, !dbg !9
  %subkernel.retval.i = alloca i32, align 4, !dbg !9
  call void @subkernel_await_args(), !dbg !13
  %subkernel.arg.stack = call i8* @llvm.stacksave(), !dbg !13
  %rpc.ret.alloc = alloca i32, align 4, !dbg !13
  %rpc.ret.ptr = bitcast i32* %rpc.ret.alloc to i8*, !dbg !13
  br label %rpc.head, !dbg !13

rpc.head:                                         ; preds = %rpc.continue, %entry
  %rpc.ptr = phi i8* [ %rpc.ret.ptr, %entry ], [ %rpc.alloc, %rpc.continue ], !dbg !13
...
rpc.tail:                                         ; preds = %rpc.head
  %rpc.ret = load i32, i32* %rpc.ret.alloc, align 4, !dbg !13
  call void @llvm.stackrestore(i8* %subkernel.arg.stack), !dbg !13
  %subkernel.arg.stack.1 = call i8* @llvm.stacksave(), !dbg !13
  %rpc.ret.alloc.1 = alloca i32, align 4, !dbg !13
  %rpc.ret.ptr.1 = bitcast i32* %rpc.ret.alloc.1 to i8*, !dbg !13
...
rpc.tail.1:                                       ; preds = %rpc.head.1
  %rpc.ret.1 = load i32, i32* %rpc.ret.alloc.1, align 4, !dbg !13
  call void @llvm.stackrestore(i8* %subkernel.arg.stack.1), !dbg !13
  %0 = bitcast { i8*, i32 }* %.14.i to i8*, !dbg !14
...
=======
  %UNN.4.i = add i32 %rpc.ret, %rpc.ret.1, !dbg !14
  %.14.repack.i = getelementptr inbounds { i8*, i32 }, { i8*, i32 }* %.14.i, i32 0, i32 0, !dbg !9
  store i8* getelementptr inbounds ([2 x i8], [2 x i8]* @S.i, i32 0, i32 0), i8** %.14.repack.i, align 8, !dbg !9
  %.14.repack1.i = getelementptr inbounds { i8*, i32 }, { i8*, i32 }* %.14.i, i32 0, i32 1, !dbg !9
  store i32 2, i32* %.14.repack1.i, align 4, !dbg !9
  store i32 %UNN.4.i, i32* %subkernel.retval.i, align 4, !dbg !9
  %3 = bitcast i8** %subkernel.return.i to i32**, !dbg !9
  store i32* %subkernel.retval.i, i32** %3, align 4, !dbg !9
  call void @subkernel_send_message(i32 0, { i8*, i32 }* nonnull %.14.i, i8** nonnull %subkernel.return.i), !dbg !9
...
=======
declare void @subkernel_await_args() local_unnamed_addr
...
=======
!9 = !DILocation(line: 22, column: 8, scope: !10, inlinedAt: !12)
!10 = distinct !DISubprogram(name: "_Z46artiq_run_test_subkernel.DMAPulses.simple_argszz", linkageName: "_Z46artiq_run_test_subkernel.DMAPulses.simple_argszz", scope: !11, file: !11, line: 20, type: !6, scopeLine: 20, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !3, retainedNodes: !8)
!11 = !DIFile(filename: "test_subkernel.py", directory: "")
!12 = distinct !DILocation(line: 1, scope: !5)
!13 = !DILocation(line: 1, scope: !5)
!14 = !DILocation(line: 21, column: 12, scope: !10, inlinedAt: !12)
>>>>>>> ff18ac7b5 (don't waste time and bandwidth with returning Nones)
